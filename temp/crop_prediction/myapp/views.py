    ...
    try:
        ...
        if request.method == "POST":
            ...
            if R:
                ...
                API_KEY = "yZDHHmrPqunYj3RIie8ex_Tj8TC-Ilw7aBUERUuIsak7"
                ...
                response_scoring = requests.post(
                    'https://au-syd.ml.cloud.ibm.com/ml/v4/deployments/44387a9a-a73c-469c-8c90-e5a699e577b8/predictions?version=2021-05-01',
